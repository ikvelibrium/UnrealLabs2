...
def create_material_instances(parent_material, asset_path, new_asset_name):
...
def get_random_color():
    return unreal.LinearColor(unreal.MathLibrary.rand_range(0.0, 1.0),
                              unreal.MathLibrary.rand_range(0.0, 1.0),
                              unreal.MathLibrary.rand_range(0.0, 1.0))

def get_random_bright_color():
    return unreal.LinearColor(unreal.MathLibrary.rand_range(0.5, 1.0),
                              unreal.MathLibrary.rand_range(0.5, 1.0),
                              unreal.MathLibrary.rand_range(0.5, 1.0))
...
def create_material_instance_for_texture(parent_material, instance_name, texture, color):
    ...
    material_instance = create_material_instances(parent_material, material_asset_path, instance_name)

    unreal.MaterialEditingLibrary.set_material_instance_texture_parameter_value(material_instance, 'MainTex', texture)
    unreal.MaterialEditingLibrary.set_material_instance_vector_parameter_value(material_instance, 'Tint', get_random_color())
